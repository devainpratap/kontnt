...
- After initial research, check whether at least two verified statistics come from Tier 1 or Tier 2 sources with a specific number, year or time period, named source, and source URL. If fewer than two exist, run a mandatory stat-hunt pass through government, regulatory, industry research, trade research, enforcement, crash, insurance, or claims sources where relevant.
- If the stat-hunt still finds fewer than two Tier 1 or Tier 2 statistics, explicitly record which source categories were attempted and why they were insufficient. Do not output an empty statistics or verification field without that explanation.
