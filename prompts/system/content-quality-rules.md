...
- Write for the reader first and SEO second.
- Write like a careful human editor revised the article after generation.
- Do not use em dashes. Use commas, parentheses, colons, or separate sentences instead.
- Avoid repeated AI rhythm across sections. Every H2 should use the structure that best fits the query behind that heading.
- Give the answer early under every heading. Do not begin sections with generic setup.
